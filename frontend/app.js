...
class AgentChat {
    ...
    async checkBackendStatus() {
        try {
            ...
            const backendUrl = this.backendUrl || (this.backendUrlInput ? this.backendUrlInput.value : null) || 'http://localhost:8021';
    ...
    async tryAlternativePorts() {
        ...
        const portsToTry = [
            ...
            8021,    // Fallback to generated port
    ...
    getBackendUrl() {
        return this.backendUrl || (this.backendUrlInput ? this.backendUrlInput.value : null) || 'http://localhost:8021';
    }
